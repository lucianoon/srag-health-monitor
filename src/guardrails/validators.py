...
class InputValidator:
    ...
    def sanitize_search_query(query: str) -> str:
        ...
        # Remover caracteres especiais perigosos (escape e formato corrigidos)
        # Remove <, >, ", ', %, ;, (, ), &, + — evita injeção de HTML/JS e alguns operadores.
        pattern = r'[<>"'%;()&+]'
...
if __name__ == "__main__":
    # Testes locais (inalterados além da regex)
